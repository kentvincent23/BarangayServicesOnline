        ...
        <div id="panel-applications">
            ...
            <div class="flex flex-col md:flex-row gap-3 mb-6">
                ...
                <div class="relative">
                    <select id="type-filter" onchange="applyFilters()"
                        class="appearance-none w-full md:w-64 px-5 py-3 pr-10 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 font-bold text-slate-700 text-sm cursor-pointer">
                ...
                <div class="flex gap-2 flex-wrap">
                    <button onclick="setStatus('all')" id="status-all"
                        class="status-btn px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all bg-slate-800 text-white">
                        All
                    </button>
                    <button onclick="setStatus('approved')" id="status-approved"
                        class="status-btn px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all bg-slate-100 text-slate-500 hover:bg-slate-200">
                        Approved
                    </button>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                <table class="w-full text-left">
                    ...
                    <tbody id="app-table-body" class="divide-y divide-slate-50">
                        @forelse($applications ?? [] as $app)
                            <tr class="app-row group transition-all hover:bg-slate-50/50"
                    ...
                    <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-5 gap-3 sm:gap-4">
                           <div class="sm:col-span-2 space-y-2">
                                ...
                                class="w-full px-4 sm:px-5 py-3 sm:py-4 bg-slate-50 border-none rounded-xl sm:rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 font-semibold text-sm cursor-not-allowed" readonly required>
                            </div>
                            ...
                            <div class="sm:col-span-1 space-y-2">
                                ...
                                <input type="text" name="middle_initial" maxlength="1"
                                    ...
                                    class="w-full px-4 sm:px-5 py-3 sm:py-4 bg-slate-50 border-none rounded-xl sm:rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 font-semibold text-center uppercase text-sm cursor-not-allowed" readonly>
                            </div>
                            <div class="sm:col-span-2 space-y-2">
                                <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Last Name</label>
